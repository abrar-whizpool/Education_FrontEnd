  ...
  <div class="container-fluid p-0">
    <div class="row no-gutters">
      <div class="col-xl-4 col-lg-5 align-self-end">
        <img class="img-fluid w-100" src="/source/images/banner/banner-feature.png" alt="banner-feature"/>
      </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 order-1 order-md-2 mb-4 mb-md-0">
        <img class="img-fluid w-100" src="/source/images/about/about-us.jpg" alt="about image"/>
      </div>
    </div>
  </div>
</section>
...
<section class="section bg-gray">
  ...
  <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
    <div class="card border-0 rounded-0 hover-shadow">
      <div class="card-img position-relative">
        <img class="card-img-top rounded-0" src="/source/images/events/event-1.jpg" alt="event thumb"/>
  ...
  <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
    <div class="card border-0 rounded-0 hover-shadow">
      <div class="card-img position-relative">
        <img class="card-img-top rounded-0" src="/source/images/events/event-2.jpg" alt="event thumb"/>
  ...
  <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
    <div class="card border-0 rounded-0 hover-shadow">
      <div class="card-img position-relative">
        <img class="card-img-top rounded-0" src="/source/images/events/event-3.jpg" alt="event thumb"/>
...
<section class="section pt-0">
  ...
  <article class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
    <div class="card rounded-0 border-bottom border-primary border-top-0 border-left-0 border-right-0 hover-shadow">
      <img class="card-img-top rounded-0" src="/source/images/blog/post-1.jpg" alt="Post thumb"/>
      <div class="card-body">
        {/*<!-- post meta -->*/}
  ...
  <article class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
    <div class="card rounded-0 border-bottom border-primary border-top-0 border-left-0 border-right-0 hover-shadow">
      <img class="card-img-top rounded-0" src="/source/images/blog/post-2.jpg" alt="Post thumb"/>
      <div class="card-body">
        {/*<!-- post meta -->*/}
        <ul class="list-inline mb-3">
          {/*<!-- post date -->*/}
  ...
  <article class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
    <div class="card rounded-0 border-bottom border-primary border-top-0 border-left-0 border-right-0 hover-shadow">
      <img class="card-img-top rounded-0" src="/source/images/blog/post-3.jpg" alt="Post thumb"/>
      <div class="card-body">
        {/*<!-- post meta -->*/}
        <ul class="list-inline mb-3">
          {/*<!-- post date -->*/}
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-sm-8 mb-5 mb-lg-0">
          {/*<!-- logo -->*/}
          <a class="logo-footer" href="index.html"><img class="img-fluid mb-4" src="/source/images/logo.png" alt="logo"/></a>
